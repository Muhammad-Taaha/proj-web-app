...
interface GoogleGeminiEffectProps {
  pathLengths: MotionValue<number>[]; // Must be MotionValue<number>
  title?: string;
  description?: string;
  className?: string;
}
...
export const GoogleGeminiEffect: React.FC<GoogleGeminiEffectProps> = ({
  ...
  // Animate each pathLength MotionValue
  useEffect(() => {
  ...
  return (
    <div className={cn("sticky top-80", className)}>
      ...
      >
        ...
        />
        {/** Add other paths similarly, using pathLengths[2], pathLengths[3], etc. */}
