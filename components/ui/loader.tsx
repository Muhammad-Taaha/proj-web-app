...
export const LoaderFour = ({ text = "Loading..." }: { text?: string }) => (
  <div className="relative font-bold text-black [perspective:1000px] dark:text-white">
    ...
    <motion.span
      ...
      transition={{ duration: 0.5, repeat: Infinity, repeatType: "reverse", ease: easeInOut, times: [0, 0.2, 0.5, 0.8, 1] }}
    >
      {text}
    </motion.span>
    ...
    <motion.span
      ...
      transition={{ duration: 0.8, repeat: Infinity, repeatType: "reverse", ease: easeInOut, times: [0, 0.3, 0.6, 0.8, 1] }}
    >
      {text}
    </motion.span>
  </div>
